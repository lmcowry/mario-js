...
function determineHeightAndThenDrawPyramid() {
    ...
    heightStr = document.getElementById('heightInput').value;
...
heightButton.addEventListener("click", determineHeightAndThenDrawPyramid);
 ...
 */
 function drawPyramid(height) {
     ...
     var previousPyramids = document.getElementById("pyramid");
     while (previousPyramids.firstChild) {
         previousPyramids.removeChild(previousPyramids.firstChild);
     }
